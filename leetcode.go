...
// const (
// 	// Hostname string = "sz-ll-09234"
// 	// username string = "shuaiwang"
// 	token string = "iNocsugyjszvssdTWuvB"
// 	url   string = "https://code.autox.ds/api/v4"
// )
...
// 	err = ioutil.WriteFile("/home/shuaiwang/.ssh/id_ed25519", privateKey, 0600)
// 	if err != nil {
// 		log.Fatalln(err)
// 	}

// 	err = ioutil.WriteFile("/home/shuaiwang/.ssh/id_ed25519.pub", authorizedKey, 0644)
// 	if err != nil {
// 		log.Fatalln(err)
// 	}

// 	user, err := user.Lookup("shuaiwang")
...
// 	err = os.Chown("/home/shuaiwang/.ssh/id_ed25519", uid, gid)
// 	if err != nil {
// 		log.Fatalln(err)
// 	}
// 	err = os.Chown("/home/shuaiwang/.ssh/id_ed25519.pub", uid, gid)
// 	if err != nil {
// 		log.Fatalln(err)
// 	}
...
// 	}
// 	log.Println("create transCfg")
// 	httpClient := &http.Client{
// 		Transport: transCfg,
// 	}
// 	log.Println("create httpClient")

// 	gl, err := gitlab.NewClient(token, gitlab.WithBaseURL(url), gitlab.WithHTTPClient(httpClient))
// 	log.Println("create gitlab")
// 	if err != nil {
...
// 	username := "shuaiwang"
// 	listUser := gitlab.ListUsersOptions{Username: &username}

// 	getedUsers, getUserRes, err := gl.Users.ListUsers(&listUser)
// 	if err != nil {
// 		log.Fatalln(&getUserRes, err)
// 	}

// 	userID := getedUsers[0].ID
// 	log.Println(userID)
// 	// log.Println(getedUsers)
// 	// log.Println(&getedUsers.Username)
// 	// for user := getedUsers {
// 	// 	log.Println(user.ID)
// 	// }
// 	// fmt.Println(userID)
...
// 	title := "go-test"
// 	log.Println(title)
// 	key, err := ioutil.ReadFile("/home/shuaiwang/.ssh/id_ed25519.pub")
// 	log.Println("get ssh key")
// 	if err != nil {
// 		log.Fatalln(err)
// 	}

// 	stringKey := string(key)
// 	log.Println(stringKey)

// 	sshKey := gitlab.AddSSHKeyOptions{Title: &title, Key: &stringKey}

// 	sshKeyRes, sshAddGitlabRes, err := gl.Users.AddSSHKeyForUser(userID, &sshKey)

// 	if err != nil {
// 		log.Fatalln(&sshKeyRes, &sshAddGitlabRes, err)
// 	}
// 	log.Println(&sshKeyRes, &sshAddGitlabRes)
...
func CheckSudo() {
	...
	log.Println(curUser.Uid)

	if curUser.Uid != "0" {
		log.Fatalln("You are not running with root permission!")
	}
}
